Feature: Agent
  ...
  Scenario Outline: create a domain
    Given a public key
    And a domain has been created by the holder of this public key
    # child properties
    And a child of this domain has the name <name>
    ...
    And this domain makes the promise "I will keep any promise I make."
    And this domain makes the promise "If one of my ancestors makes a promise, then I also make that promise."
